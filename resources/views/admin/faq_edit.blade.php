				...
				<div class="card-body">
					<form action="{{route("admin_faq_update",$faq->id)}}" method="POST">
						...
						<div class="form-group">
							<label>Soru</label>
							<input type="text" value={{$faq->question}} name="question" required placeholder="Soru" class="form-control">
						</div>
						<div class="form-group">
							<label>Cevap</label>
							<textarea  name="answer" required id="answer" placeholder="answer" class="form-control">{{$faq->answer}}</textarea>
						</div>
						<div class="form-group">
