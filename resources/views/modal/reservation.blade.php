	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action='{{asset("reservation")}}' name="reservation" id="reservation">
					
					<p>Üyemiz değilseniz bilgilerinizle otomatik üyelik açılacaktır. </p>
					<p><input type="text" class="form-control" name="name" id="name" placeholder="Adınız" required></p>
					<p><input type="text" class="form-control" name="surname" id="surname" placeholder="Soyadınız" required></p>
					<p><input type="email" class="form-control" name="email" id="email" placeholder="E-mail" required></p>
