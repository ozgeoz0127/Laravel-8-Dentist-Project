		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action='{{Route("appointment")}}' name="appointment" id="appointment">
                   ...
                   @if (Auth::check())
                        <p class="alert alert-success">Talebiniz admin tarafından onaylandıktan sonra geçerli olacaktır</p>
                        <p><input  value="{{Auth::user()->name}}" type="text" class="form-control" name="name" id="name" placeholder="Adınız" required></p>
                        <p><input  value="{{Auth::user()->surname}}" type="text" class="form-control" name="surname" id="surname" placeholder="Soyadınız" required></p>
                        <p><input  value="{{Auth::user()->email}}" type="email" class="form-control" name="email" id="email" placeholder="E-mail" required></p>
                    ...
                    @else
                        <p class="alert alert-danger">Rezervasyon yapmak için üye girişi yapınız</p>
                    @endif
